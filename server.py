...
logging.info("Starting game server on port %s, http on port %s" % (args.port, args.http_port))

httpSite = server.Site(lib.http.PentagoHttp(manager))
...
reactor.listenTCP(args.http_port, httpSite)
